...
//     await _generateScreen(pascalCase, snakeCase, useCubit);
//
...
//   static Future<void> _generateRepository(String pascalCase, String snakeCase) async {
...
//   static Future<void> _generateRepositoryImpl(String pascalCase, String snakeCase) async {
//     final content = '''import 'package:dartz/dartz.dart';
//
...
//     // Events file
//     final eventsContent = '''part of '${snakeCase}_bloc.dart';
//
// /// Abstract base event for $pascalCase
...
// }
//
// /// Event to load all ${snakeCase}s
// final class Load${pascalCase}s extends ${pascalCase}Event {
//   const Load${pascalCase}s();
// }
//
// /// Event to load a specific ${snakeCase} by ID
// final class Load${pascalCase}ById extends ${pascalCase}Event {
//   final int id;
//
//   const Load${pascalCase}ById(this.id);
//
//   @override
//   List<Object> get props => [id];
// }
//
// /// Event to create a new ${snakeCase}
// final class Create${pascalCase} extends ${pascalCase}Event {
//   final ${pascalCase}Entity ${camelCase};
//
//   const Create${pascalCase}(this.${camelCase});
//
//   @override
//   List<Object> get props => [${camelCase}];
// }
//
// /// Event to update an existing ${snakeCase}
// final class Update${pascalCase} extends ${pascalCase}Event {
//   final ${pascalCase}Entity ${camelCase};
//
//   const Update${pascalCase}(this.${camelCase});
//
//   @override
//   List<Object> get props => [${camelCase}];
// }
//
// /// Event to delete a ${snakeCase}
// final class Delete${pascalCase} extends ${pascalCase}Event {
//   final int id;
//
//   const Delete${pascalCase}(this.id);
//
//   @override
//   List<Object> get props => [id];
// }
//
// /// Event to search ${snakeCase}s
// final class Search${pascalCase}s extends ${pascalCase}Event {
//   final String query;
//
//   const Search${pascalCase}s(this.query);
//
//   @override
//   List<Object> get props => [query];
// }
//
// /// Event to refresh ${snakeCase}s
// final class Refresh${pascalCase}s extends ${pascalCase}Event {
//   const Refresh${pascalCase}s();
// }''';
//
//     // States file (similar to Cubit states)
//     final statesContent = '''part of '${snakeCase}_bloc.dart';
//
// /// Abstract base state for $pascalCase
// sealed class ${pascalCase}State extends Equatable {
//   const ${pascalCase}State();
...
//
//     // Main Bloc file
//     final blocContent = '''import 'package:equatable/equatable.dart';
// import 'package:flutter_bloc/flutter_bloc.dart';
//
// import '../../../core/utils/logger.dart';
// import '../../../core/utils/performance_monitor.dart';
...
// part '${snakeCase}_state.dart';
//
// /// Bloc for managing $pascalCase state
// ///
// /// This bloc handles the presentation logic for ${snakeCase} operations.
// /// It processes events and emits appropriate states for the UI.
// ///
// /// Key responsibilities:
...
//     on<Load${pascalCase}s>(_onLoad${pascalCase}s);
//     on<Load${pascalCase}ById>(_onLoad${pascalCase}ById);
//     on<Create${pascalCase}>(_onCreate${pascalCase});
//     on<Update${pascalCase}>(_onUpdate${pascalCase});
//     on<Delete${pascalCase}>(_onDelete${pascalCase});
//     on<Search${pascalCase}s>(_onSearch${pascalCase}s);
//     on<Refresh${pascalCase}s>(_onRefresh${pascalCase}s);
//   }
//
//   /// Handles Load${pascalCase}s event
//   Future<void> _onLoad${pascalCase}s(Load${pascalCase}s event, Emitter<${pascalCase}State> emit) async {
//     Logger.bloc('🎯 Bloc: Handling Load${pascalCase}s event');
//
//     // Don't show loading if we have cached data
//     if (_cached${pascalCase}s.isEmpty) {
//       emit(const ${pascalCase}Loading());
//       PerformanceMonitor.monitorCubitStateChange('${pascalCase}Bloc', 'Initial', 'Loading');
//     }
//
//     final result = await _get${pascalCase}sUseCase();
//
//     result.fold(
//       (failure) {
//         Logger.bloc('❌ Bloc: Failed to load ${snakeCase}s - \${failure.message}');
//         emit(${pascalCase}Error(failure.message, failure.statusCode));
//         PerformanceMonitor.monitorCubitStateChange('${pascalCase}Bloc', 'Loading', 'Error');
//       },
//       (${snakeCase}s) {
//         Logger.bloc('✅ Bloc: Successfully loaded \${${snakeCase}s.length} ${snakeCase}s');
//         _cached${pascalCase}s = ${snakeCase}s;
//         emit(${pascalCase}sLoaded(${snakeCase}s));
//         PerformanceMonitor.monitorCubitStateChange('${pascalCase}Bloc', 'Loading', 'Loaded');
//       },
//     );
//   }
//
//   /// Handles Load${pascalCase}ById event
//   Future<void> _onLoad${pascalCase}ById(Load${pascalCase}ById event, Emitter<${pascalCase}State> emit) async {
//     Logger.bloc('🎯 Bloc: Handling Load${pascalCase}ById event for ID: \${event.id}');
//
//     emit(const ${pascalCase}Loading());
//
//     final result = await _get${pascalCase}ByIdUseCase(event.id);
//
//     result.fold(
//       (failure) {
//         Logger.bloc('❌ Bloc: Failed to load ${snakeCase} \${event.id} - \${failure.message}');
//         emit(${pascalCase}Error(failure.message, failure.statusCode));
//       },
//       (${camelCase}) {
//         Logger.bloc('✅ Bloc: Successfully loaded ${snakeCase}: \${${camelCase}.name}');
//         emit(${pascalCase}Loaded(${camelCase}));
//       },
//     );
//   }
//
//   /// Handles Create${pascalCase} event
//   Future<void> _onCreate${pascalCase}(Create${pascalCase} event, Emitter<${pascalCase}State> emit) async {
//     Logger.bloc('🎯 Bloc: Handling Create${pascalCase} event');
//
//     emit(const ${pascalCase}Creating());
//
//     final result = await _create${pascalCase}UseCase(event.${camelCase});
//
//     result.fold(
//       (failure) {
//         Logger.bloc('❌ Bloc: Failed to create ${snakeCase} - \${failure.message}');
//         emit(${pascalCase}Error(failure.message, failure.statusCode));
//       },
//       (created${pascalCase}) {
//         Logger.bloc('✅ Bloc: Successfully created ${snakeCase}: \${created${pascalCase}.name}');
//
//         // Add to cache
//         _cached${pascalCase}s = [..._cached${pascalCase}s, created${pascalCase}];
//
...
//   }
//
//   /// Handles Update${pascalCase} event
//   Future<void> _onUpdate${pascalCase}(Update${pascalCase} event, Emitter<${pascalCase}State> emit) async {
//     Logger.bloc('🎯 Bloc: Handling Update${pascalCase} event for ID: \${event.${camelCase}.id}');
//
//     emit(const ${pascalCase}Updating());
//
//     final result = await _update${pascalCase}UseCase(event.${camelCase});
//
//     result.fold(
//       (failure) {
//         Logger.bloc('❌ Bloc: Failed to update ${snakeCase} - \${failure.message}');
//         emit(${pascalCase}Error(failure.message, failure.statusCode));
//       },
//       (updated${pascalCase}) {
//         Logger.bloc('✅ Bloc: Successfully updated ${snakeCase}: \${updated${pascalCase}.name}');
//
//         // Update cache
//         _cached${pascalCase}s = _cached${pascalCase}s.map((item) =>
//           item.id == updated${pascalCase}.id ? updated${pascalCase} : item
...
//   }
//
//   /// Handles Delete${pascalCase} event
//   Future<void> _onDelete${pascalCase}(Delete${pascalCase} event, Emitter<${pascalCase}State> emit) async {
//     Logger.bloc('🎯 Bloc: Handling Delete${pascalCase} event for ID: \${event.id}');
//
//     emit(const ${pascalCase}Deleting());
//
//     final result = await _delete${pascalCase}UseCase(event.id);
//
//     result.fold(
//       (failure) {
//         Logger.bloc('❌ Bloc: Failed to delete ${snakeCase} - \${failure.message}');
//         emit(${pascalCase}Error(failure.message, failure.statusCode));
//       },
//       (success) {
//         Logger.bloc('✅ Bloc: Successfully deleted ${snakeCase} ID: \${event.id}');
//
//         // Remove from cache
//         _cached${pascalCase}s = _cached${pascalCase}s.where((item) => item.id != event.id).toList();
//
//         emit(${pascalCase}Deleted(event.id));
//       },
//     );
//   }
//
//   /// Handles Search${pascalCase}s event
//   Future<void> _onSearch${pascalCase}s(Search${pascalCase}s event, Emitter<${pascalCase}State> emit) async {
//     Logger.bloc('🎯 Bloc: Handling Search${pascalCase}s event with query: "\${event.query}"');
//
...
//     emit(const ${pascalCase}Searching());
//
//     final result = await _search${pascalCase}sUseCase(event.query);
//
//     result.fold(
//       (failure) {
//         Logger.bloc('❌ Bloc: Failed to search ${snakeCase}s - \${failure.message}');
//         emit(${pascalCase}Error(failure.message, failure.statusCode));
//       },
//       (${snakeCase}s) {
//         Logger.bloc('✅ Bloc: Found \${${snakeCase}s.length} ${snakeCase}s for query: "\${event.query}"');
//         emit(${pascalCase}SearchResults(${snakeCase}s, event.query));
//       },
//     );
//   }
//
//   /// Handles Refresh${pascalCase}s event
//   Future<void> _onRefresh${pascalCase}s(Refresh${pascalCase}s event, Emitter<${pascalCase}State> emit) async {
//     Logger.bloc('🔄 Bloc: Handling Refresh${pascalCase}s event');
//     _cached${pascalCase}s.clear(); // Clear cache to force reload
//     add(const Load${pascalCase}s());
//   }
// }''';
//
//     await _writeFile('lib/presentation/bloc/${snakeCase}/${snakeCase}_bloc.dart', blocContent);
//     await _writeFile('lib/presentation/bloc/${snakeCase}/${snakeCase}_event.dart', eventsContent);
//     await _writeFile('lib/presentation/bloc/${snakeCase}/${snakeCase}_state.dart', statesContent);
//   }
//
//   /// Generates StatefulWidget screen
//   static Future<void> _generateScreen(String pascalCase, String snakeCase, bool useCubit) async {
...
// import '../../../core/utils/performance_monitor.dart';
// import '../../../domain/entities/${snakeCase}_entity.dart';
// import '../../${useCubit ? 'cubit' : 'bloc'}/${snakeCase}/${snakeCase}_${useCubit ? 'cubit' : 'bloc'}.dart';
...
//         : '${snakeCase}${stateManagerType}.add(const Load${pascalCase}s());'
//       }
//     });
//   }
//
...
//             _buildSearchBar(),
//             Expanded(
//               child: Bloc${useCubit ? '' : ''}Builder<$stateManagerClass, $stateClass>(
...
//               LoadingWidget(),
//               SizedBox(height: 16),
//               CustomText(text: 'Updating ${snakeCase}...'),
//             ],
//           ),
//         );
//
//       case ${pascalCase}Deleting():
//         return const Center(
//           child: Column(
//             mainAxisAlignment: MainAxisAlignment.center,
//             children: [
//               LoadingWidget(),
//               SizedBox(height: 16),
//               CustomText(text: 'Deleting ${snakeCase}...'),
//             ],
//           ),
//         );
//
//       case ${pascalCase}Searching():
//         return const Center(
//           child: Column(
//             mainAxisAlignment: MainAxisAlignment.center,
//             children: [
//               LoadingWidget(),
//               SizedBox(height: 16),
//               CustomText(text: 'Searching ${snakeCase}s...'),
//             ],
//           ),
//         );
//
...
//
//       case ${pascalCase}Updated():
//         WidgetsBinding.instance.addPostFrameCallback((_) {
//           _showSuccessSnackBar('${pascalCase} updated successfully');
//         });
//         return _build${pascalCase}ListView(${snakeCase}${stateManagerType}.cached${pascalCase}s);
//
//       case ${pascalCase}Deleted():
//         WidgetsBinding.instance.addPostFrameCallback((_) {
//           _showSuccessSnackBar('${pascalCase} deleted successfully');
//         });
//         return _build${pascalCase}ListView(${snakeCase}${stateManagerType}.cached${pascalCase}s);
//
//       default:
...
//           onSelected: (value) => _on${pascalCase}Action(value, ${camelCase}),
//           itemBuilder: (context) => [
//             const PopupMenuItem(
//               value: 'edit',
//               child: Row(
...
//       : '${snakeCase}${stateManagerType}.add(const Refresh${pascalCase}s());'
//     }
//   }
//
...
//           : '${snakeCase}${stateManagerType}.add(Search${pascalCase}s(query));'
//         }
//       }
//     });
//   }
...
//       : '${snakeCase}${stateManagerType}.add(const Search${pascalCase}s(\'\'));'
//     }
//   }
//
...
//     // Navigator.pushNamed(context, RouteNames.create${pascalCase}Screen);
...
//     // Navigator.pushNamed(context, RouteNames.${snakeCase}DetailsScreen, arguments: ${camelCase});
//     _showInfoSnackBar('View ${snakeCase} details: \${${camelCase}.name}');
//   }
//
//   void _on${pascalCase}Action(String action, ${pascalCase}Entity ${camelCase}) {
//     switch (action) {
//       case 'edit':
//         // TODO: Navigate to edit ${snakeCase} screen
//         // Navigator.pushNamed(context, RouteNames.edit${pascalCase}Screen, arguments: ${camelCase});
//         _showInfoSnackBar('Edit ${snakeCase}: \${${camelCase}.name}');
//         break;
//       case 'delete':
//         _confirmDelete(${camelCase});
//         break;
//     }
//   }
//
//   void _confirmDelete(${pascalCase}Entity ${camelCase}) {
//     showDialog(
//       context: context,
//       builder: (context) => AlertDialog(
//         title: const Text('Delete ${pascalCase}'),
//         content: Text('Are you sure you want to delete "\${${camelCase}.name}"?'),
//         actions: [
//           TextButton(
...
//               ${useCubit
//                 ? '${snakeCase}${stateManagerType}.delete${pascalCase}(${camelCase}.id);'
//                 : '${snakeCase}${stateManagerType}.add(Delete${pascalCase}(${camelCase}.id));'
//               }
//             },
...
//     ${useCubit ? 'BlocProvider' : 'BlocProvider'}<${pascalCase}${stateManagerType}>(
...
// export 'presentation/${useCubit ? 'cubit' : 'bloc'}/${snakeCase}/${snakeCase}_${useCubit ? 'cubit' : 'bloc'}.dart';
// ''';
//
//     content += '\n$imports';
//
...
//     print('Usage: dart tool/improved_code_generator.dart <feature_name> [options]');
//     print('');
//     print('Options:');
...
//     print('');
//     print('Examples:');
//     print('  dart tool/improved_code_generator.dart user_profile');
//     print('  dart tool/improved_code_generator.dart product --bloc');
//     print('  dart tool/improved_code_generator.dart notification --no-mapper');
//     return;
//   }
//
